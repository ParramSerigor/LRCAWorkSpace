<%@ Page Title="" Language="C#" MasterPageFile="~/MDE.Master" AutoEventWireup="true" CodeBehind="MDE_AproTPApps.aspx.cs" Inherits="LRCA.MDE_AproTPApps" %>
        ...
        <div class="panel-body">
            <div id="hbreadcrumb" class="pull-right">
                <ol class="hbreadcrumb breadcrumb">
                    <li>MDE</li>
                    <li class="active">
                        <span>Approved/Rejected Training Provider Accreditations Applications</span>
                    </li>
                </ol>
            </div>
            <h2 class="font-light m-b-xs">         
          Training Provider Accreditations Closed Applications
            </h2>
            <small>This module is for MDE staff to manage Approved/Denied Training Provider Accreditations applications.</small>
        </div>
    </div>
</div>
                ...
                <div class="hpanel">
                    ...
                    <div class="panel-heading">
                        <a class="showhide">
                           ...
                           Approved Training Provider Accreditations Applications
                        </a>
                    </div>
                ...
                <div class="hpanel">
                    ...
                    <div class="panel-heading">
                        <a class="showhide">
                           ...
                           Rejected Training Provider Accreditations Applications
                        </a>
                    </div>
