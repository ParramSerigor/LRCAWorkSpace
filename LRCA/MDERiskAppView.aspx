<%@ Page Title="" Language="C#" MasterPageFile="~/MDE.Master" AutoEventWireup="true" CodeBehind="MDERiskAppView.aspx.cs" Inherits="LRCA.MDERiskAppView" %>
      ...
      <div class="hpanel">
        <div class="panel-body">
          ...
          <asp:Label ID="lblContractorApp" runat="server" ></asp:Label></span>         
            ...
            <p>Application  for Inspector & Risk Assessor Accreditation<asp:Label ID="lblCourseName" runat="server" ></asp:Label>.</p>
     ...
     <div class="hpanel">
        ...
        <div class="alert" style="background-color:#fff; color:#000;">
             <div class="row">
                 ...
                 <div class="col-lg-4">
                     <asp:DropDownList ID="dropCategory" CssClass="form-control m-b" onchange="CategoryIs()" multiple="multiple"  ToolTip="Category" runat="server">
         ...
         <div class="alert" style="background-color:#000; color:#fff; text-align:center; height:20px; top:5px;">
          ...
          <div class="alert" style="background-color:#fff; color:#000;">
                ...
                <p>File format: Number, Date, Address, City, State, ZipCode, Type of Inspection (i.e. XRF, paint chip, or dust)</p>
                 <span >
					 <asp:HyperLink runat="server" ID="lkupload" CssClass="btn btn-xs btn-success" Target="_blank"></asp:HyperLink>
                 </span>   
                 </div>
                <div class="alert" style="background-color:#000; color:#fff; text-align:center; height:20px; top:5px;">
