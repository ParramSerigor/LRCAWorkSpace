<%@ Page Title="" Language="C#" MasterPageFile="~/MDE.Master" AutoEventWireup="true" CodeBehind="MDE_AproInstApps.aspx.cs" Inherits="LRCA.MDE_AproInstApps" %>
        ...
        <div class="panel-body">
            <div id="hbreadcrumb" class="pull-right">
                <ol class="hbreadcrumb breadcrumb">
                    <li>MDE</li>
                    <li class="active">
                        <span>Approved/Denied Instructor Accreditations applications</span>
                    </li>
                </ol>
            </div>
            <h2 class="font-light m-b-xs">         
          Instructor Accreditations Completed Applications
            </h2>
            <small>This module is for MDE staff to manage Approved/Denied Instructor Accreditations applications.</small>
        </div>
    </div>
</div>
                ...
                <div class="hpanel">
                    ...
                    <div class="panel-heading">
                        <a class="showhide">
                           ...
                           Approved Instructor Accreditations applications
                        </a>
                    </div>
                ...
                <div class="hpanel">
                    ...
                    <div class="panel-heading">
                        <a class="showhide">
                           ...
                           Disapproved Instructor Accreditations applications
                        </a>
                    </div>
