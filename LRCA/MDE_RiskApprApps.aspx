<%@ Page Title="" Language="C#" MasterPageFile="~/MDE.Master" AutoEventWireup="true" CodeBehind="MDE_RiskApprApps.aspx.cs" Inherits="LRCA.MDE_RiskApprApps" %>
        ...
        <div class="panel-body">
            <div id="hbreadcrumb" class="pull-right">
                <ol class="hbreadcrumb breadcrumb">
                    <li>MDE</li>
                    <li class="active">
                        <span>Approved/Rejected Inspector & Risk Assessor Accreditations Applications</span>
                    </li>
                </ol>
            </div>
            <h2 class="font-light m-b-xs">         
          Inspector & Risk Assessor Accreditations Closed Applications
            </h2>
            <small>This module is for MDE staff to manage Approved/Denied Inspector & Risk Assessor Accreditations applications.</small>
        </div>
    </div>
</div>
                ...
                <div class="hpanel">
                    ...
                    <div class="panel-heading">
                        <a class="showhide">
                           ...
                           Approved Inspector & Risk Assessor Accreditations Applications
                        </a>
                    </div>
                ...
                <div class="hpanel">
                    ...
                    <div class="panel-heading">
                        <a class="showhide">
                           ...
                           Rejected Inspector & Risk Assessor Accreditations Applications
                        </a>
                    </div>
                    ...
                    <thead>
											...
											<tbody>
                                                <asp:Panel ID="pnlDisapproved" runat="server"></asp:Panel>
											</tbody>
										</table>
                </div>
        </div>
